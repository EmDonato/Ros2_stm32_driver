...
SERVICE_NAME="open-pi-stm32-driver"

LOG_DIR="$SCRIPT_DIR/../../script_logs"
LOG_FILE="$LOG_DIR/stm32_driver.txt"
...
check_stm32_driver() {
    ...
    if ! compgen -G "/dev/ttyACM*" >/dev/null; then
        die "No stm32_driver found in /dev/ttyACM*"
    fi
}
...
build_image() {
    ...
    echo "[INFO] Building stm32_driver image"
...
create_container() {
    ...
    echo "[INFO] Building and starting stm32_driver container"
...
start_container() {
    ...
    echo "[INFO] Starting stm32_driver container"
...
stop_container() {
    ...
    echo "[INFO] Stopping stm32_driver container"
...
restart_container() {
    ...
    echo "[INFO] Restarting stm32_driver container"
...
remove_container() {
    ...
    echo "[INFO] Stopping and removing stm32_driver container"
